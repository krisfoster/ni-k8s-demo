...
mvn clean package
docker push phx.ocir.io/oracledeveloper/k8s-perf-demo:jibber.openjdk.0.0.2-SNAPSHOT
...
docker push phx.ocir.io/oracledeveloper/k8s-perf-demo:jibber.native.0.0.2-SNAPSHOT
